...
public class CustomGridViewActivityCodeGrid extends BaseAdapter {
  ...
  //  private final ImageView[][] imageView= new ImageView[11][6];
    ...
    public CustomGridViewActivityCodeGrid(Context context, int[] gridViewImageId, int[][] tabuleiro ) {
        mContext = context;
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
                ...
                gridViewAndroid = inflater.inflate(R.layout.gridview_layout_code, null);
            ...
            if ((linha<=9) && (coluna<=8) ){
                ...
                imageViewButton.setImageResource(R.drawable.casarobo);
            ...
            imageViewButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (temp[0].equals("W")) {
                        c.setImageResource(R.drawable.robo);
                        ...
                        c.setImageResource(R.drawable.casarobo);
